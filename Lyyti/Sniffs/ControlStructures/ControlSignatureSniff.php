 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Lyyti_Sniffs_ControlStructures_ControlSignatureSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (isset($tokens[$stackPtr]['parenthesis_closer']) === true
            ...
            if ($found !== 1) {
                $error = 'Expected newline after closing parenthesis; found "%s"';
        ...
        if ($found !== 1) {
            $error = 'Expected newline after closing brace; %s found';
            $data  = array($found);
